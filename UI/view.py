...
class View:
    ...
    def load_interface(self):
        ...
        self.pulsante_mostra_cammino_minimo = ft.ElevatedButton("Mostra Cammino Minimo", width=200,
                                                                on_click = self.controller.handle_mostra_cammino_minimo if self.controller else None)
        row3 = ft.Row([self.pulsante_mostra_cammino_minimo], alignment=ft.MainAxisAlignment.CENTER)
